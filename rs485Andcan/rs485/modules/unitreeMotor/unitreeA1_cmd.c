...
motor_recv_t Date_left;      // 右腿电机接收数据体
motor_recv_t id00_left_date; // 右腿00号电机接收数据体
motor_recv_t id01_left_date; // 右腿01号电机接收数据体
motor_recv_t id02_left_date; // 右腿02号电机接收数据体
